...
This file is the quick-reference operating contract for clap-complete-kotlin. The longer
...
clap-complete-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`clap_complete`](https://crates.io/crates/clap_complete). Upstream Rust is the behavioral oracle while the
