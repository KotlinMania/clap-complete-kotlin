...
kotlin {
    ...
    val xcf = XCFramework("ClapComplete")
    ...
    swiftExport {
        moduleName = "ClapComplete"
        flattenPackage = "io.github.kotlinmania.clapcomplete"
    }

    android {
        namespace = "io.github.kotlinmania.clapcomplete"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "clap-complete-kotlin", version.toString())

    pom {
        name.set("clap-complete-kotlin")
        description.set("Kotlin Multiplatform port of clap-rs/clap - Generate shell completion scripts for your clap::Command")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/clap-complete-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/clap-complete-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/clap-complete-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/clap-complete-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleClapCompleteXCFramework",
    "assembleClapCompleteDebugXCFramework",
    "assembleClapCompleteReleaseXCFramework",
    "assembleDebugIosFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseIosFatFrameworkForClapCompleteXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForClapCompleteXCFramework",
    "assembleDebugMacosFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseMacosFatFrameworkForClapCompleteXCFramework",
    "assembleDebugTvosFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseTvosFatFrameworkForClapCompleteXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForClapCompleteXCFramework",
    "assembleDebugWatchosFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseWatchosFatFrameworkForClapCompleteXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForClapCompleteXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForClapCompleteXCFramework",
